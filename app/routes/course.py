...
@router.get("/get-enrollments", tags=['Course Details Page'])
...
@router.get("/get-sftl", tags=['Course Details Page'])
...
@router.get("/get-reviews", tags=['Course Details Page'])
